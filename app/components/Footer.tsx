export default function Footer() {
  return (
    <footer className="w-full px-6 py-8 bg-neutral-950 text-neutral-400 flex justify-center gap-8">
      {/* LinkedIn */}
      <a
        href="https://linkedin.com/in/sdeture"
        target="_blank"
        rel="noopener"
        aria-label="LinkedIn"
      ...
      {/* Essays link */}
      <a href="/posts" className="hover:text-indigo-400 transition">
        Essays
      </a>
    </footer>
  );
